  ...
  return (
    ...
    >
      <Row>
        ...
        <Col flex={3}>
          <h1>
            Your Innovative Bill <br></br>Payment Solution
          </h1>
          <p>
            Alterra menyediakan berbagai pilihan layanan tagihan & pembayaran
            digital <br></br> yang dapat membantu bisnis Anda semakin
            berkembang.
          </p>
        ...
        <Col flex={5}>
          <img
            src="https://www.alterra.id/wp-content/uploads/2020/01/CoverPotrait-400x480.png"
            srcset="https://www.alterra.id/wp-content/uploads/2020/01/CoverPotrait.png 2x"
            class="full-width"
            alt="alterra"
          ></img>
        </Col>
        ...
        <Col flex={5} align="justify">
          ...
          >
            ...
            <p style={{ fontSize: "16px", color: "gray" }}>
              ...
              Sepulsa.com. <br></br> Sebagai perusahaan teknologi terkemuka di
              Indonesia yang berfokus pada ekosistem billing dan teknologi
              pembayaran,<br></br> Alterra Indonesia kini telah terhubung ke
              berbagai penerbit tagihan (Bill Issuers) dan metode pembayaran{" "}
              <br></br> yang populer di Indonesia. Melalui sebuah innovative
              platform Alterra Indonesia menyediakan layanan yang dapat
              <br></br>menghubungkan semua penerbit tagihan (Bill Issuers),
              Digital Commerce, dan juga End-User.
            </p>
          </div>
        </Col>
      </Row>
      ...
      <Row align="center">
          ...
          <ul>
            <li>
              ...
              <div>
                ...
                <p>
                  Alterra Indonesia telah bermitra dengan lebih dari
                  200e-commerce & digital <br></br>commerce ternama di
                  Indonesia, danampu memproses<br></br> hingga puluhan juta
        ...
        <Col flex={6}>
          <div>
            <img
              src="https://www.alterra.id/wp-content/themes/alterra-wp/assets/revamp/img/img_tech_companies.svg"
              class="full-width"
            />
          </div>
        </Col>
